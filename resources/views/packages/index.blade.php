                        ...
                        <div class="card-body">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-md-12 col-12 form-group mandatory">
                                    ...
                                    {{ Form::label('productId', __('Product ID'), ['class' => 'form-label col-12 ']) }}
                        ...
                        <form action="{{ url('package-update') }}" class="form-horizontal" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group mandatory">
                                        <label for="edit_name" class="form-label col-12 ">{{ __('Product Id') }}</label>
                                        <input type="text" id="edit_ios_product_id" class="form-control col-12"
                                            placeholder="Product Id" name="edit_ios_product_id"
                                            data-parsley-required="true">
...
@section('script')
    <script>
        ...
        function setValue(id) {
            ...
            $("#edit_id").val(id);
            $("#edit_ios_product_id").val($("#" + id).parents('tr:first').find('td:nth-child(2)').text());

            $("#edit_name").val($("#" + id).parents('tr:first').find('td:nth-child(3)').text());
            $("#edit_duration").val($("#" + id).parents('tr:first').find('td:nth-child(4)').text());
            $("#edit_price").val($("#" + id).parents('tr:first').find('td:nth-child(5)').text());
            var status = ($("#" + id).parents('tr:first').find('td:nth-child(8)').text());
            if (status == "ON") {
                $('option[value=1]').attr('selected', true);
            } else {
                $('option[value=0]').attr('selected', true)
            }
            property_limit = ($("#" + id).parents('tr:first').find('td:nth-child(6)').text());
            advertisement_limit = ($("#" + id).parents('tr:first').find('td:nth-child(7)').text());
