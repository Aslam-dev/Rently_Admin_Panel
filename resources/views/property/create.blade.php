                ...
                <div class="row card-body">
                    <div class="col-md-6 col-sm-12 form-group mandatory">
                        ...
                        <textarea id="meta_title" name="meta_title" class="form-control"
                            oninput="getWordCount('meta_title','meta_title_count','12.9px arial')" rows="2" required style="height: 75px"></textarea>
                    ...
                    <div class="col-md-6 col-sm-12 form-group mandatory card">
                    ...
                    <div class="col-md-12 col-sm-12 form-group mandatory">
                        ...
                        <textarea id="meta_description" name="meta_description" class="form-control"
                            oninput="getWordCount('meta_description','meta_description_count','12.9px arial')" rows="3" required></textarea>
                        <br>
                    ...
                    <div class="col-md-12 col-sm-12 form-group mandatory">
                        ...
                        <textarea name="keywords" id="" class="form-control" rows="3" required></textarea>
                        (add comma separated keywords)

                    </div>
                    {{-- <div class="col-md-12 col-sm-12 form-group mandatory card">
                        {{ Form::label('image', __('Image'), ['class' => 'form-label']) }}
                        <input type="file" name="meta_image" required id="meta_image" class="form-control filepond">
